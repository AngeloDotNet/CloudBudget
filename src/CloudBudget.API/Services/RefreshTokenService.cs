...
{
    // durata refresh token (configurabile in futuro)
    private readonly TimeSpan refreshTtl = TimeSpan.FromDays(30);

    public async Task<RefreshToken> CreateRefreshTokenAsync(Guid userId, string jwtId, CancellationToken ct = default)
    {
